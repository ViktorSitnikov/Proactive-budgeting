  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          { label: "Общая точность", value: "93.4%", sub: "+1.2% за неделю", icon: TargetIcon, color: "text-primary", bg: "bg-primary/10" },
          { label: "Запросов/мин", value: "1,240", sub: "Пик: 2,400", icon: Activity, color: "text-primary", bg: "bg-primary/10" },
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-6">
                  ...
                  <div className="flex flex-col items-end gap-2">
                    <Badge className="bg-primary/20 text-primary border-none uppercase text-[10px] font-black">
                      {model.status}
                    </Badge>
                ...
                <div className="grid grid-cols-3 gap-6 mb-6">
                  <div className="space-y-1">
                    ...
                    <p className="text-lg font-black text-primary">{model.accuracy}%</p>
                  </div>
                  <div className="space-y-1">
                  ...
                  {showLogs === model.id && (
                    ...
                    >
                      <div className="bg-slate-50 rounded-xl p-4 font-mono text-[10px] space-y-2">
                        ...
                        <div className="text-primary">[2024-03-01] Epoch 50/50: loss: 0.0234 - accuracy: 0.9812</div>
                        ...
                        <div className="text-primary">[2024-03-01] Starting training on 12,400 new samples.</div>
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>
        ...
        <div className="space-y-6">
                ...
                {[
                  ...
                  <div key={i} className="flex gap-3 leading-relaxed">
                    ...
                    <span className={
                      ...
                      log.type === 'SUCCESS' ? 'text-primary' : 'text-primary-foreground'
                    }>[{log.type}]</span>
          ...
          <Card className="border-none shadow-lg bg-gradient-to-br from-primary to-primary/80 text-white">
            <CardContent className="p-6">
              ...
              <p className="text-xs text-primary-foreground mb-4 leading-relaxed">
