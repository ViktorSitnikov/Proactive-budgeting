          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-4 border-l pl-6">
              <div className="hidden md:block text-right">
                ...
                <p className="text-[10px] uppercase font-black text-primary tracking-tighter mt-1">НКО-Партнер</p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div whileHover={{ y: -8 }} transition={{ type: "spring", stiffness: 300 }}>
              ...
              >
                ...
                <CardHeader>
                  <div className="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center mb-4 group-hover:bg-primary transition-all duration-500 transform group-hover:rotate-12">
            ...
            <motion.div whileHover={{ y: -8 }} transition={{ type: "spring", stiffness: 300 }}>
              ...
              >
                <div className="h-2 w-full bg-primary" />
                <CardHeader>
                  <div className="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center mb-4 group-hover:bg-primary transition-all duration-500">
                    <UserIcon className="w-8 h-8 text-primary group-hover:text-white" />
                  </div>
          ...
          <div className="bg-slate-900 rounded-[40px] p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl">
              <h3 className="text-3xl font-black mb-4 italic">
                «Сила города — в его людях и их инициативности»
              </h3>
