...
=========================================
ДАТА СОЗДАНИЯ: ${formatBeautifulDate(new Date())}
  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent>
          <div className="space-y-6">
            <div className="p-6 bg-slate-50 rounded-lg border-2 border-slate-200 space-y-4">
              ...
              <div className="bg-muted p-4 rounded border border-border flex items-start gap-3">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button size="lg" onClick={onNext} className="gap-2 bg-primary hover:bg-primary/90 text-primary-foreground font-bold">
